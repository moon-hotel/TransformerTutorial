...
def translate_german_to_english(srcs, config):
    ...
    loaded_paras = torch.load(config.model_save_dir + '/model.pt')
...
# [2025-02-21 00:20:50] - INFO: # 正在构建词表: /root/workspace/Code/data/train.de
# 29000it [03:48, 126.80it/s]
# [2025-02-21 00:24:39] - INFO: # 正在构建词表: /root/workspace/Code/data/train.en
# 29000it [03:41, 131.01it/s]
# 德语：Eine Gruppe von Menschen steht vor einem Iglu.
# 翻译： A people in front .
# 英语：A group of people are facing an igloo.
#
#
# 德语：Ein Mann in einem blauen Hemd steht auf einer Leiter und putzt ein Fenster.
# 翻译： A man in a blue shirt standing on a window .
